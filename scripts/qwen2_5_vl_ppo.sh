...
ACTOR_MODEL_NAME_OR_PATH="/aifs4su/hansirui_1st/models/Qwen2.5-VL-7B-Instruct" # model path
CRITIC_MODEL_NAME_OR_PATH="/aifs4su/hansirui_1st/models/Qwen2.5-VL-7B-Instruct" # model path
