...
MODEL_NAME_OR_PATH="Qwen/Qwen2.5-VL-7B-Instruct" # model path
...
EVAL_TEMPLATE="Qwen2-VL" # dataset template, reuse the template of Qwen2-VL
EVAL_NAME="text-video-to-text" # dataset name
EVAL_SPLIT="val" # split the dataset

OUTPUT_DIR="../outputs/qwen_2_5_vl_rm" # output dir
