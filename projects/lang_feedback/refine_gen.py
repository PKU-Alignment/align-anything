...
def main() -> None:
    ...
    for idx in range(len(data)):
        ...
        response = data[idx]['output_text'].replace('<image>', ' image ')
        critique = data[idx]['critique'].replace('<image>', ' image ')
        problem = {
            'prompt': PROMPT_INPUT.format(prompt=prompt, response=response, critique=critique),
