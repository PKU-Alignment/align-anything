...
# ref: https://huggingface.co/CaasiHUANG/flames-scorer/blob/main/modeling_internlm.py
...
from eval_anything.benchmarks.text_to_text.Flames.configuration_internlm import InternLMConfig
