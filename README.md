...
* **[2025.02.28]** ⚡️🤝 我们支持了align-anything在Huawei Ascend NPU上的训练与推理。
...
* **[2025.02.19]** We supported the alignment fine-tuning of MiniCPM-o (audio & image), also included in [the official repository’s README recommendations](https://github.com/OpenBMB/MiniCPM-o#with-align-anything-). See [GRPO Trainer](https://github.com/PKU-Alignment/align-anything/blob/main/align_anything/trainers/text_to_text/grpo.py).
