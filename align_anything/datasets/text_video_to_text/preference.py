...
class PreferenceDataset(Dataset):
    ...
    def preprocess(self, raw_sample: dict[str, Any]) -> PreferenceSample:
        ...
        better_input_ids = self.tokenizer(
            processed_better_text, add_special_tokens=False, return_tensors='pt'
        )['input_ids'][0]
        worse_input_ids = self.tokenizer(
            processed_worse_text, add_special_tokens=False, return_tensors='pt'
        )['input_ids'][0]
