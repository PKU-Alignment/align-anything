...
from transformers import AutoConfig, Qwen3Model, Qwen3PreTrainedModel
from transformers.models.qwen3.modeling_qwen3 import Qwen3ForCausalLM

from align_anything.models.reward_model import ScoreModelOutput


class AccustomedQwen3Model(Qwen3ForCausalLM):
    """Accustomed Interface for Qwen3 model"""
...
class AccustomedQwen3RewardModel(Qwen3PreTrainedModel):
