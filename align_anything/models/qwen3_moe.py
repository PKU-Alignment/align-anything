...
from transformers import AutoConfig, Qwen3MoeModel, Qwen3MoePreTrainedModel
from transformers.models.qwen3_moe.modeling_qwen3_moe import Qwen3MoeForCausalLM

from align_anything.models.reward_model import ScoreModelOutput


class AccustomedQwen3MoeModel(Qwen3MoeForCausalLM):
    """Accustomed Interface for Qwen3 Moe model"""
...
class AccustomedQwen3MoeRewardModel(Qwen3MoePreTrainedModel):

    supports_gradient_checkpointing = True

    def __init__(self, config: AutoConfig):
        super().__init__(config)
        setattr(self, self.base_model_prefix, Qwen3MoeModel(config))
