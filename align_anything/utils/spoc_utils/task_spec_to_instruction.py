...
from align_anything.utils.spoc_utils.constants.object_constants import AI2THOR_OBJECT_TYPE_TO_WORDNET_SYNSET
...
from align_anything.utils.spoc_utils.constants.template_verbs import GOTO_POINT_VERBS, GOTO_VERBS, PICKUP_VERBS
from align_anything.utils.spoc_utils.objaverse_annotation import get_objaverse_annotations
from align_anything.utils.spoc_utils.synset_utils import (
...
# )["train"].data
SYNSET_TO_BEST_LEMMA = json.load(open("align_anything/utils/spoc_utils/synset_to_best_lemma.json", "r"))
