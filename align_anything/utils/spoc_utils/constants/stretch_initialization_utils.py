...
from align_anything.utils.spoc_utils.constants.objaverse_data_dirs import OBJAVERSE_ASSETS_DIR
from align_anything.utils.spoc_utils.type_utils import THORActions
