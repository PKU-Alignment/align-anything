...
from align_anything.utils.utils.constants.template_verbs import GOTO_POINT_VERBS, GOTO_VERBS, PICKUP_VERBS
...
# )["train"].data
SYNSET_TO_BEST_LEMMA = json.load(open("align_anything/utils/utils/synset_to_best_lemma.json", "r"))
