    ...
    def load_dataset(self) -> DatasetDict:
        ...
        for task in self.task_names:
            ...
            for prompt, input_ids, pixel_values, question_id in zip(
                prompts, inputs['input_ids'], inputs['pixel_values'], dataset['question_id']
            ):
...
class AOKVQAGeneratorDS(BaseInferencer_deepspeed):
    def eval(
...
def main():
    ...
    dict_configs, infer_configs = read_eval_cfgs('a-okvqa', 'deepspeed')
    ...
    eval_module = AOKVQAGeneratorDS(model_config, infer_configs)
