...
from align_anything.evaluation.inference.base_inference import BaseInferencer, json, os
...
class AudioCapsDataLoader(BaseDataLoader):
    ...
    def load_dataset(self, gen_dir):
        ...
        if all_data:
            eval_dir = all_data['audio_path']
            background_dir = all_data['audio_path_real']
