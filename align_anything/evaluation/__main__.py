...
def parse_eval_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        "-b",
        default=None,
        help="The benchmark you want to test on. Choices: ARC, BBH, Belebele, CMMLU, GSM8K, HumanEval, MMLU, MMLUPRO, mt-bench, PAWS-X, RACE, TruthfulQA, MME, MMBench, MMMU, POPE, MMVet, MathVista, MM-SafetyBench, TextVQA, VizWizVQA, SPA-VL, A-OKVQA, llava-bench-in-the-wild, llava-bench-coco, ScienceQA, MMStar, LongBench, AGIEval, Eval-Anything, HPSv2, MSCOCO, ChronoMagicBench, AudioCaps, MSCOCO_ImageReward",
        choices=[
            ...
            "ScienceQA", "MMStar", "LongBench", "AGIEval",
            "Eval-Anything", "HPSv2", "MSCOCO",
            "ChronoMagicBench", "AudioCaps", "MSCOCO_ImageReward"
        ],
    )
    parser.add_argument(
        "--model_id",
