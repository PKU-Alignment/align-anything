...
class ChatTemplate():
    ...
    def format_preference_sample(self, raw_sample: dict[str, Any]) -> tuple[str, str, Any]:
        ...
        return self.model_formatter(better_conversation), self.model_formatter(worse_conversation), multi_modal_info
    ...
    def format_unmatched_supervised_sample(self, raw_sample_for_prompt: dict[str, Any], raw_sample_for_response: dict[str, Any]) -> tuple[str, Any]:
